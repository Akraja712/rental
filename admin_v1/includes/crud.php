...
define('DOMAIN_URL', 'http://rental.graymatterworks.com/admin_v1/'); /* chnage to your domain here - don't forget to add forward slash at the end of the URL like this "/" */
